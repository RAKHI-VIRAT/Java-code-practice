...
public class ClassC 
{
	...
	void meth1() // Instance / normal / concrete / non-static
	{
		...
		System.out.println("instance variable x : "+new ClassC().x ); // by using class object
		
		System.out.println("Static variable y : "+y); //by using identifier name
		System.out.println("Static variable y : "+new ClassC().y); //by using class object
		System.out.println("Stativ variable y : "+ClassC.y);// by using class name *****
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("--------\n");
		ClassC.meth2(); //calling by (class name)******
		System.out.println("--------\n");
	}
